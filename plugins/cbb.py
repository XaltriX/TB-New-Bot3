...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>Cʀᴇᴀᴛᴏʀ :<a href='https://t.me/FileDatas_bot'>Tʜɪs Gᴜʏ</a>\n\nLᴀɴɢᴜᴀɢᴇ🗄 :<a>Pʏᴛʜᴏɴ</a>\n\nLɪʙʀᴀʀʏ🗃 : <a>Pʏʀᴏɢʀᴀᴍ</a>\n\nSᴏᴜʀᴄᴇ Cᴏᴅᴇ📄 : <a href='https://t.me/FileDatas_bot'>Gᴇᴛ Hᴇʀᴇ</a>\n\nDᴇᴠ🪛 : <a href='https://t.me/teraslinks'>Scorp</a></b>",
